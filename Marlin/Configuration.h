...
#define CUSTOM_MACHINE_NAME "DeltaMaker"
...
#define DELTA
  ...
  #define DELTA_SEGMENTS_PER_SECOND 160 // FMH: was 200
  ...
  // FMH: Equals 109.13mm for DeltaMaker

  // Print surface diameter/2 minus unreachable space (avoid collisions with vertical towers).
  #define DELTA_PRINTABLE_RADIUS 80 // FMH: Fine-tune this later 
                                    // Original DM was 115!?!?! (was 140.0 in sample code)
                                    // Was 140.0 in Marlin sample code
  ...
  // FMH: Where is safe zone defined?  Answer: Z_MAX_POS which is ultimately MANUAL_Z_HOME_POS 
  //      which is set to 285 which is the distance between the nozzle to printbed after homing.
  //	  How does it get distance from end stops from that?
  //      Currently seems to settle about 40mm lower than usual home position
...
//#define ENDSTOP_INTERRUPTS_FEATURE  // FMH: Revisit this, would be cool if it worked..
...
#define AUTO_BED_LEVELING_BILINEAR // FMH: This is the only allowed choice for delta
...
#define DEBUG_LEVELING_FEATURE // FMH: Remember to disable when done with tuning
  ...
  #define ABL_GRID_MAX_POINTS_X 3 //FMH: 3 for faster debugging //9
...
#define MANUAL_Z_HOME_POS 285 // Distance between the nozzle to printbed after homing FMH: Need to optimize
